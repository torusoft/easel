...
</h1><div class="col-12 col-last nav-authentication"><p>You are currently logged in as <em>Admin User</em>. <a href="/" class="btn"><span>Public Site</span></a> <a href="/account" class="btn"><span>Profile</span></a> <a href="/logout" class="btn"><span>Logout</span></a>
...
</div><div class="select col-last col-6"><label for="product_template_customer_id">Customer</label> <select class="col-6" id="product_template_customer_id" name="product_template[customer_id]"><option value="1">Meijer</option></select>
