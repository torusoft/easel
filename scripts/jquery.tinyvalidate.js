...
$.fn.tinyvalidate.defaults.summary = {
  ...
  preNotice: '<p>There was a problem processing your request. <br>Please correct the {num} highlighted {field|fields} and try again.</p><ul class="reset">',
  postNotice: '</ul>',
  noticeAnimate: {
    effect: 'fadeIn',
    speed: 400  
